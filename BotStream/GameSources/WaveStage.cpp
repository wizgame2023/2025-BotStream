...
namespace basecross {
    ...
    void WaveStage::OnCreate()
    {
            ...
            //wave1敵
            enemyMgr->InstEnemy(Vec3(0.0f, 5.5f, -75.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f*5.0f, 0.7f*5.0f, 0.7f*5.0f));
            enemyMgr->InstEnemy(Vec3(-10.0f, 5.5f, -85.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f * 5.0f, 0.7f * 5.0f, 0.7f * 5.0f));
            enemyMgr->InstEnemy(Vec3(10.0f, 5.5f, -85.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f * 5.0f, 0.7f * 5.0f, 0.7f * 5.0f));
    ...
    void WaveStage::OnUpdate()
    {
        ...
        if (m_waveNow == 1 && EnemyNum == 0)
        {
            ...
            //ウェーブ２敵
            enemyMgr->InstEnemy(Vec3(-15.0f, 5.5f, 10.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f * 5.0f, 0.7f * 5.0f, 0.7f * 5.0f));
            enemyMgr->InstEnemy(Vec3(-10.0f, 5.5f, 20.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f * 5.0f, 0.7f * 5.0f, 0.7f * 5.0f));
            enemyMgr->InstEnemy(Vec3(0.0f, 5.5f, 10.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f * 5.0f, 0.7f * 5.0f, 0.7f * 5.0f));
            enemyMgr->InstEnemy(Vec3(10.0f, 5.5f, 20.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f * 5.0f, 0.7f * 5.0f, 0.7f * 5.0f));
            enemyMgr->InstEnemy(Vec3(15.0f, 5.5f, 10.0f), Vec3(0.0f, -5.0f, 0.0f), Vec3(0.7f * 5.0f, 0.7f * 5.0f, 0.7f * 5.0f));
